...
from gyptis.__about__ import __author__, __description__, __name__, __version__
...
html_context = {
    ...
    "show_fork": True,
    "repo": f"{__name__}/{__name__}",
    "show_pip_install": True,
    "pipname": __name__,
    "dockername": f"{__name__}/{__name__}",
}
...
htmlhelp_basename = f"{__name__}_doc"
...
sphinx_gallery_conf = {
    ...
    "ignore_pattern": r"^(?!plot_).+\.py$",  # ignore files that do not start with plot_
    # "first_notebook_cell": (
